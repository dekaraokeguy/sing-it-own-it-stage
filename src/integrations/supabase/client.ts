...
// Define database types for easier access
export type Tables = Database['public']['Tables'];
export type Users = Tables['users']['Row'];
export type Performances = Tables['performances']['Row'];
export type Votes = Tables['votes']['Row'];
export type VoteSummary = Database['public']['Views']['vote_summary']['Row'];
